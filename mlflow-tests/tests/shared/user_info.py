...
class UserInfo:
    ...
    def __init__(self, uname: Optional[str] = None, upass: Optional[str] = None, workspace: Optional[str] = None, resource_types: Optional[list[ResourceType]] = None, verbs: Optional[list[KubeVerb]] = None, subresources: Optional[list[str]] = None):
        """Initialize UserInfo with username, password, workspace, resource type, and verbs.
    ...
    def __eq__(self, other) -> bool:
        ...
        return (self._uname == other._uname and
                ...
                self._subresources == other._subresources)
