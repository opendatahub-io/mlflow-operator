...
from .actions import upgrade_actions
from .post_upgrade import test_3_10 as post_upgrade_tests
...
def test_build_post_upgrade_steps_reads_configmap_handoff_first() -> None:
    steps = post_upgrade_tests.build_post_upgrade_steps(lambda _: None)
    assert steps[0].action_func is upgrade_actions.action_read_pre_upgrade_version_configmap
